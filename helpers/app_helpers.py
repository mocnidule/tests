...
def find_contract_and_assert():
    ...
    title = WebDriverWait(driver.instance, 10).until(ec.presence_of_element_located((By.XPATH, transaction_title)))
...
def recipient_transfer_contract():
    ...
    handle_default_window()
    transaction_title = "//p[contains(text(),'" + read_contract_title() + "')]"
    WebDriverWait(driver.instance, 10).until(ec.invisibility_of_element((By.XPATH, transaction_title)))
...
def decline_then_approve_withdrawal():
    ...
    WebDriverWait(driver.instance, 10).until(ec.element_to_be_clickable((By.XPATH, confirm_withdraw_button))).click()
    handle_second_window()
    WebDriverWait(driver.instance, 10).until(ec.element_to_be_clickable((By.XPATH, reject_button))).click()
    handle_default_window()
...
def top_up_common():
    WebDriverWait(driver.instance, 10).until(ec.element_to_be_clickable((By.XPATH, top_up_button))).click()
    ...
    WebDriverWait(driver.instance, 10).until(ec.element_to_be_clickable((By.XPATH, confirm_top_up_button))).click()
    handle_new_window()
    WebDriverWait(driver.instance, 10).until(ec.element_to_be_clickable((By.XPATH, approve_button))).click()
    handle_default_window()
