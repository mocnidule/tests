...
def fill_batch_details():
    ...
    driver.instance.find_element(By.XPATH, wallet_two).send_keys('HQusf1yxnzwcWBCYZcRRhJnRscng3RQofAVZ5KSBoDPf')
    driver.instance.find_element(By.XPATH, wallet_three).send_keys('3dUkYworYstcd1p91PTUPUYLqV7VgJyQri6xybRuKwkA')
